...
RUN R -e "install.packages(c('RCurl','pmml', 'jsonlite', 'blockcluster', 'Matrix', 'vegan', 'jpeg'), repos='http://cran.cc.uoc.gr/mirrors/CRAN/')"
COPY clusteringPkg_1.0.tar.gz /packages/
USER root
